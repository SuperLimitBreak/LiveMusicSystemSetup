...
DOCKER_IMAGES=${DOCKER_IMAGE_DISPLAYTRIGGER} ${DOCKER_IMAGE_SUBSCRIPTIONSERVER} ${DOCKER_IMAGE_STAGEORCHESTRATION} ${DOCKER_IMAGE_MEDIATIMELINERENDERER} ${DOCKER_IMAGE_DISPLAYTRIGGER_PRODUCTION} ${DOCKER_IMAGE_MEDIAINFOSERVICE}
